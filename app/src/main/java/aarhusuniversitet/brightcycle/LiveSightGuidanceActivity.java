...
//        checkPermissions();
    ...
    private void initialize() {
        setContentView(R.layout.activity_live_sight_guidance);
            ...
            m_compositeFragment.init(new OnEngineInitListener() {
                ...
                public void onEngineInitializationCompleted(OnEngineInitListener.Error error) {
                    if (error == OnEngineInitListener.Error.NONE) {
                        ...
                        Log.d("TEST", "ERROR: Cannot initialize Composite Fragment");
                    }
                }
            });
        }
    ...
    public void startLiveSight(View view) {
        if (m_arController != null) {
            ...
            ARController.Error error = m_arController.start();
    ...
    public void stopLiveSight(View view) {
        ...
        if (m_arController != null) {
            m_arController.addOnLivesightStatusListener(new ARController.OnLivesightStatusListener() {
                @Override
                public void onLivesightStatus(ARController.Error error) {
            ...
            ARController.Error error = m_arController.stop(true);
            if (error.equals("NONE")) {
    ...
    private void startLiveSightRouting() {
        ...
        m_routeOptions.setTransportMode(RouteOptions.TransportMode.PEDESTRIAN);
    ...
    private void startLiveSightGuidance() {
        ...
        m_navigationManager.setMapUpdateMode(NavigationManager.MapUpdateMode.NONE); // No need to update map as
        ...
        m_navigationManager.setTrafficAvoidanceMode(NavigationManager.TrafficAvoidanceMode.DISABLE);
     ...
     *
     * @param waypoint geo-cooridnate waypointer object is pointing to.
     */
    private void createARWaypointerObject(GeoCoordinate waypoint) {
        ...
        try {
            texture.setImageResource(R.drawable.ic_action_location);
        } catch (IOException e) {
            e.printStackTrace();
            return;
        }
        ...
        m_arWaypointerObject.setShadingMode(ARModelObject.ShadingMode.FLAT_TEXTURED);
     ...
     * resource.
     *
     * @param location       Geo-coordinate of a billboard.
     * @param iconResourceId Resource id of the texture for the billboard.
     * @param width          Width of a billboard expressed in meters.
     */
     ...
     * image.
     *
     * @param coordinate Geo-coordinate of a billboard.
     * @param img        Image of the texture for the billboard.
     * @param width      Width of a billboard expressed in meters.
     */
    private void addARBillboard(GeoCoordinate coordinate, Image img, float width) {
        ...
        m_arNextManeuverBillboard.setOrientation(ARBillboardObject.Orientation.BILLBOARD);
        m_arNextManeuverBillboard.setShadingMode(ARModelObject.ShadingMode.FLAT_TEXTURED);
